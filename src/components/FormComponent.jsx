...
const FormComponent = () => {
  ...
  const handleAiSubmit = async (e) => {
    ...
    alert(
      "Since the LLM models are not deployed this feature is not working in live mode. Please check out the full working demo at : https://drive.google.com/file/d/12jvfVjfq8gJN4CdFLeehEtNWUrxWesP1/view?usp=drive_link"
    );
    return;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios({
        method: "post",
        url: "https://critiqall-backend-1.onrender.com/api/form/question",
        data: allData,
      });
