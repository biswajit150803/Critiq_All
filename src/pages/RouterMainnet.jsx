...
import tokens from "../routerNitro/main.json";
            ...
            <div className="absolute top-4 w-full px-4 md:px-8 sm:top-8">
              <div className="flex justify-between">
                ...
                <div className="flex flex-col sm:flex-row relative gap-2 items-center">
                  ...
                  {isOpen && (
                    <div className="absolute top-2 z-10 w-full mt-10 bg-[#2c2c34] rounded-md max-h-[360px] min-w-[180px] overflow-y-auto scrollbar scrollbar-w-2 scrollbar-thumb-rounded-full scrollbar-h-0">
