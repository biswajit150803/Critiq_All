...
const Profile = () => {
  ...
  React.useEffect(() => {
    const getDiam = async () => {
      const res = await axios.get(
        "https://critiqall-backend-1.onrender.com/getbalance",
  ...
  return (
    <div className="text-white flex flex-col mt-[4vh] md:mt-[20vh] md:justify-evenly md:flex-row">
      <div className="leftprof text-2xl">
        <h1>Profile</h1>
