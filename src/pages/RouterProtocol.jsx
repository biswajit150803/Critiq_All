...
const RouterProtocol = () => {
  ...
  const walletConnect = async () => {
    ...
    console.log(networkId, selectedToken1.chainId, selectedToken.chainId);
    if (networkId !== selectedToken.chainId) {
      let s =
        "Please switch to " +
        selectedToken.name +
        " network before executing the transaction else it will fail!";
      toast.error(s);
    }
            ...
            <div className="absolute top-4 w-full px-4 md:px-8 sm:top-8">
              <div className="flex justify-between">
                ...
                <div className="flex flex-col sm:flex-row relative gap-2 items-center">
                  ...
                  {isOpen && (
                    <div className="absolute top-2 z-10 w-full mt-10 bg-[#2c2c34] rounded-md max-h-[360px] min-w-[180px] overflow-y-auto  scrollbar scrollbar-w-2 scrollbar-thumb-rounded-full scrollbar-thumb-slate-500">
            ...
            <div className="absolute top-4 w-full px-4 sm:px-8 sm:top-8">
              <div className="flex justify-between">
                ...
                <div className="flex flex-col sm:flex-row relative gap-2 items-center">
                  ...
                  {isOpen1 && (
                    <div className="absolute min-w-[180px] top-2 z-10 w-full mt-10 bg-[#2c2c34] rounded-md max-h-[360px] overflow-y-auto  scrollbar scrollbar-w-2 scrollbar-thumb-rounded-full scrollbar-thumb-slate-500">
                      {tokens.testTokens.map((token, index) => (
                        <div
                          key={index}
                          className="flex items-center p-3 cursor-pointer hover:bg-[#3c3c44]"
